...
public class AltaProductoJFrame extends javax.swing.JFrame {
    ...
    public AltaProductoJFrame(ProductosPanel productosPanel) {
        initComponents();
        for (Iva iva : Iva.values()) {
            comboIVAOpciones.addItem(iva.name());
        }
    ...
    private void initComponents() {
        ...
        comboIVAOpciones = new javax.swing.JComboBox<>();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(stockProductoField, javax.swing.GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
                                    .addComponent(comboIVAOpciones, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))))
        );
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(comboIVAOpciones, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void botonCrearProductoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonCrearProductoMouseClicked
        ...
        String selectedIva = (String) comboIVAOpciones.getSelectedItem();
Iva ivaAsignado;

switch (selectedIva) {
    case "TIPO_REDUCIDO":
        ivaAsignado = Iva.TIPO_REDUCIDO;
        break;
    case "TIPO_SUPERREDUCIDO":
        ivaAsignado = Iva.TIPO_SUPERREDUCIDO;
        break;
    case "TIPO_XERAL":
        ivaAsignado = Iva.TIPO_XERAL;
        break;
    default:
        throw new IllegalArgumentException("Tipo de IVA no reconocido: " + selectedIva);
}
        ...
        nuevoProducto.setIva(ivaAsignado);
        ...
        try {
            ...
            comboIVAOpciones.setSelectedItem(null);
    ...
    private javax.swing.JComboBox<String> comboIVAOpciones;
